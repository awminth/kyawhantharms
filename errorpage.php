...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo roothtml.'lib/images/treasure.jpg' ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo roothtml.'lib/images/treasure.jpg' ?>">
    <link
